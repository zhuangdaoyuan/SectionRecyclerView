...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout
    ...
    private void initAdapter() {
        mAdapter = new TestAdapter(mDatas, this, true, false, false);
        mAdapter.setOnSectionHeaderClickListener(new SectionedRecyclerViewAdapter.OnSectionHeaderClickListener() {
            @Override
            public void onSectionHeaderClick(int section) {
                Log.e("setOnSectionHeader", section + "|");
            }
        });
        mAdapter.setOnSectionFooterClickListener(new SectionedRecyclerViewAdapter.OnSectionFooterClickListener() {
            @Override
            public void onSectionFooterClick(int section) {
                Log.e("setOnSectionFooter", section + "|");
            }
        });
        mAdapter.setOnChildClickListener(new SectionedRecyclerViewAdapter.OnChildClickListener() {
            ...
            public void onChildClick(int position, int viewType) {
                Log.e("onChildClick", position + "|" + viewType);
            }
        });
        ...
        mDivider = new SectionedGridDivider(this, 20, Color.parseColor("#CCCFFF"));
